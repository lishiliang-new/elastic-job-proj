...
public class JobConfigDO implements Serializable {
    ...
    private static final long serialVersionUID = -4923669167260948973L;
    /**
     * 主键
     */
    private Long id;
     ...
     * 分片数 默认3
     */
    private int shardTotalCount = 3;
    /**
     * 分片序列 列号从0开始,不可大于或等于作业分片总数.如：0=a,1=b,2=c
     */
    private String shardingItemParameters = "0=0,1=1,2=2";
    /**
     * (job参数不能为空多个参数以;拼接 格式如: ktrFile=/home/kettle/ktr&jobDirection=1)
     */
